      ...
      <div className="whyContent">
        ...
        <div className="reason">
          <p>
            ...
            <br />
            1人で試行錯誤しながら制作を進めることも達成感があり楽しいですが、制作する仲間と共にアイデアを出し合い、1つの作品を作り上げる過程に、より大きなやりがいを感じます。意見が衝突し、一筋縄ではいかないこともありますが、その先にある「より良いデザイン」を目指すことが、私にとっての楽しさであり、成長につながると考えています。
            <br />

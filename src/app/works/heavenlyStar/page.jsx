  ...
  return (
    <div className="heavenlyStarPage">
      ...
      <div className="workSiteImgWrapper">
        <div className="workSiteImgContent heavenlyContent">
          <div className="PcImg heavenlyPcImg"></div>
          <div className="SpImg heavenlySpImg"></div>
        </div>
      </div>
      {/* バナー系。星の名前あるとこクラス名それぞれ変更*/}
      {/* <div className="bannerImgWrapper">
        <div className="BannerImg heavenlyBannerImgLeft"></div>
        <div className="BannerImg heavenlyBannerImgRight"></div>
      </div> */}
      <BackToAllWorks />
      <Footer />
    </div>

  ...
  return (
    <div className="marsPage">
      ...
      <div className="workSiteImgWrapper">
        <div className="workSiteImgContent marsContent">
          <div className="PcImg marsPcImg"></div>
          <div className="SpImg marsSpImg"></div>
        </div>
      </div>
      {/* バナー系。星の名前あるとこクラス名それぞれ変更*/}
      {/* <div className="bannerImgWrapper">
        <div className="BannerImg marsBannerImgLeft"></div>
        <div className="BannerImg marsBannerImgRight"></div>
      </div> */}
      <BackToAllWorks />
      <Footer />
    </div>

  ...
  return (
    <div className="neptunePage">
      ...
      <div className="workSiteImgWrapper">
        <div className="workSiteImgContent neptuneContent">
          <div className="PcImg neptunePcImg"></div>
          <div className="SpImg neptuneSpImg"></div>
        </div>
      </div>
      {/* バナー系。星の名前あるとこクラス名それぞれ変更*/}
      {/* <div className="bannerImgWrapper">
        <div className="BannerImg neptuneBannerImgLeft"></div>
        <div className="BannerImg neptuneBannerImgRight"></div>
      </div> */}
      <BackToAllWorks />
      <Footer />
    </div>
